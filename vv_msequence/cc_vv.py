...
def main():
    ...
    print(f"CC V&V - Payload={PAYLOAD_RATE}")
    ...
    while True:
        try:
            ...
            for t in range(N):
                ...
                hdr_bits = viterbi(depuncture(hdr_coded, HEADER_RATE))
                ...
                payload_bits_rx = viterbi(depuncture(payload_coded, rate))
